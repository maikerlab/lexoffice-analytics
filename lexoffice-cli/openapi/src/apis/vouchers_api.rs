...
pub async fn vouchers_get(configuration: &configuration::Configuration, voucher_number: &str) -> Result<crate::models::Voucher, Error<VouchersGetError>> {
    let local_var_configuration = configuration;
...
pub async fn vouchers_id_get(configuration: &configuration::Configuration, id: &str) -> Result<crate::models::Voucher, Error<VouchersIdGetError>> {
    let local_var_configuration = configuration;
