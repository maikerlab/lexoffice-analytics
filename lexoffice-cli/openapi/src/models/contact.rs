...
pub struct Contact {
    ...
    pub company: Option<Box<crate::models::CompanyDetails>>,
    #[serde(rename = "person", skip_serializing_if = "Option::is_none")]
    pub person: Option<Box<crate::models::PersonDetails>>,
    #[serde(rename = "addresses", skip_serializing_if = "Option::is_none")]
    pub addresses: Option<Box<crate::models::ContactAddresses>>,
    #[serde(rename = "xRechnung", skip_serializing_if = "Option::is_none")]
    pub x_rechnung: Option<Box<crate::models::XRechnung>>,
    #[serde(rename = "emailAddresses", skip_serializing_if = "Option::is_none")]
    pub email_addresses: Option<Box<crate::models::ContactEmailAddresses>>,
