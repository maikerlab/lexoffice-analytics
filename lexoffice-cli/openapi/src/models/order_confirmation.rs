...
impl OrderConfirmation {
    pub fn new(id: uuid::Uuid, created_date: String, updated_date: String, version: i32, language: Language, archived: bool, voucher_status: VoucherStatus, voucher_number: String, voucher_date: String, line_items: Vec<crate::models::LineItem>) -> OrderConfirmation {
        OrderConfirmation {
            id,
