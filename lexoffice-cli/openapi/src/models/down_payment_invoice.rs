...
pub struct DownPaymentInvoice {
    ...
    #[serde(rename = "closingInvoiceId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub closing_invoice_id: Option<Option<uuid::Uuid>>,
...
impl DownPaymentInvoice {
    pub fn new(id: uuid::Uuid, created_date: String, updated_date: String, version: i32, language: Language, archived: bool, voucher_status: VoucherStatus, voucher_number: String, voucher_date: String, line_items: Vec<crate::models::LineItem>) -> DownPaymentInvoice {
        DownPaymentInvoice {
            id,
